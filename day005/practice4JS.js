...
>>>>>>> e0811112f2fce85cb4913675cc6942af955677dd
...
<<<<<<< HEAD
// 조건: 입력 받은 세 수 오름차순 정렬
// let A1 = prompt(`A: `);
// let B1 = prompt(`B: `);
// let C1 = prompt(`C: `);
=======
// 문제5처럼 해보기... 
// 조건: 입력 받은 세 수 오름차순 정렬, 참: 조건
// max 마지막에 push하고 나머지 두 개만 비교??
>>>>>>> e0811112f2fce85cb4913675cc6942af955677dd
...
<<<<<<< HEAD
// 가위를 else if로 빼면 어때 아닌가
let player1 = prompt(`플레이어1: 0(가위), 1(바위), 2(보)`);
let player2 = prompt(`플레이어2: 0(가위), 1(바위), 2(보)`);
if(엥){console.log(`플레이어1 승리`);}
else if(엥){console.log(`플레이어2 승리`);}
