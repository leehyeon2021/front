...
*****       1       12345       전체줄수(5) - 현재줄수(1) + 1
****        2       1234        전체줄수(5) - 현재줄수(2) + 1
...
// 1부터 5까지 1씩 증가한다. 
// 2. 별
// 1부터 전체줄수 - 현재줄수 +1 (5 4 3 2 1) 까지 1씩 증가
// 3. 줄마다 별.
//let html = "";
...
// 2차원 배열: 배열 안에 배열 있음. 이것도 행과 열로 생각하는 것이 낫대...
//let seatLayout = [
//    ['A1', 'A2', 'A3'], // 1행 [1] [2] [3]
//    ['B1', 'B2', 'B3'], // 2행 [1] [2] [3]
//    ['C1', 'C2', 'C3']  // 3행 [1] [2] [3]
...
//        console.log( row[col]); //행마다 col번째 열 추출/꺼내기
//    }
//}
...
//        //console.log( j + 1 );         // j와 인접한 인덱스
//        if( numbers[j] > numbers[j+1]){ // 만약에 j값이 인접한 j+1보다 더 크면 스왑
//            let temp = numbers[j];      // let temp = a;
